...
export const Home = ({ setCatchIndex, categories }) => {
  return (
    <div className="w-full h-full bg-white">
      ...
      <div className="relative">
        ...
        >
          {categories.map((el, index) => (
            <SwiperSlide key={index} className="1 p-1 border-black">
              <div className="items-center flex flex-col space-y-2">
                <img
                  ...
                  alt="Food"
                />
                <h1 className="text-[22px] flex justify-center">{el.title}</h1>
                ...
                <button onClick={() => setCatchIndex(index)}>
                  <Link
                    to={"/detail/" + index}
                    className="bg-red-600 inline-flex px-6 py-1 justify-center font-semibold text-white"
                  >
                    дэлгэрэнгүй
                  </Link>
                </button>
            ...
            <div className="items-center flex flex-col space-y-2">
              ...
              <div className="flex flex-col text-center">
                <div className="flex items-center justify-center gap-5">
                  <div className="w-[80px] h-[2px] bg-slate-300"></div>
                  <p className="text-[22px] font-bold text-red-600">
                    <span className="line-through text-slate-500">50'000₮</span>{" "}
                    - 40'000₮
                  </p>
                  <div className="w-[80px] h-[2px] bg-slate-300"></div>
                </div>
      ...
      <div className="flex justify-center p-4 bg-[#222222] text-white">
        © 2024 WP-Food
      </div>
    </div>
  );
